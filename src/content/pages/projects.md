...
I have a separate [blog](/blog/designing_lfu_cache/) on designing LFU cache.

### 🔹 [Goselect](https://github.com/SarthakMakhija/goselect)

go-select provides SQL-like ‘select’ interface for files. This means one can execute a select query like:
...
I have a separate [blog](/blog/flips_feature_flipping_for_java/) about this library.
